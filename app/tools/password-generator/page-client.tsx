            ...
            <div className="max-w-4xl mx-auto">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-8">
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed">
                        Generate strong, secure passwords with customizable options. Perfect for creating unique passwords for your accounts and
                        applications.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-6">
                        {/* Length */}
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-3">Password Length: {options.length}</label>
                            <input
                                type="range"
                                min="4"
                                max="128"
